...
using TreeGrdiWithEF.Shared.Models;
using TreeGrdiWithEF.Shared.DataAccess;
...
namespace TreeGridWebApiEFSample.Controllers
{
    ...
    public class TreeGridController : ControllerBase
    {
        ...
        public object Get()
        {
            ...
            IQueryable<TreeGrdiWithEF.Shared.Models.Task> data1 = db.GetAllRecords().AsQueryable();
            ...
            if (queryString.Keys.Contains("$select"))
            {
                data1 = (from ord in data1
                         select new TreeGrdiWithEF.Shared.Models.Task
                         {
        ...
        [HttpPost]
        public object Post([FromBody] TreeGrdiWithEF.Shared.Models.Task Task)
        {
        ...
        [HttpPut]
        public object Put([FromBody] TreeGrdiWithEF.Shared.Models.Task Task)
        {
            IQueryable<TreeGrdiWithEF.Shared.Models.Task> data2 = db.GetAllRecords().AsQueryable();
            TreeGrdiWithEF.Shared.Models.Task val = data2.Where(or => or.TaskID == Task.TaskID).FirstOrDefault();
